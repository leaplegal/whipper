...
var joi = require('joi');
var workerWrapperPath = require.resolve('./worker-wrapper');
 ...
 * @static
 */
var State = WorkerHandle.State = Object.freeze(/** @lends WorkerHandle.State */{
 ...
 */
var WorkingStatus = WorkerHandle.WorkingStatus = Object.freeze({
...
WorkerHandle.prototype._initWorker = function() {
  return new Promise(function(resolve, reject) {
    this._send('init', { moduleName: this._options.workerModulePath }).then(function() {
      if(this._options.initWorker) {
        return this.invoke(this._options.initWorker.message, this._options.initWorker.args)
      }
